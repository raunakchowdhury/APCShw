...
public int count8(int n) {
        if ( n == 8 )
                ...
                return 2 + count8( (n - n%10)/10);
        else if ( n%10 == 8)
                return 1 + count8( (n - n%10)/10);
        return 0 + count8( (n - n%10)/10);
}
...
public boolean array220(int[] nums, int index) {
        ...
        if (index == n || index + 1 == n)
                return false;
        else if (nums[index + 1] == 0 &&  nums[index] == 0)
                return true;
        else if ( nums[index + 1]/nums[index] == 10 && nums[index + 1]% nums[index] == 0)
                return true;
