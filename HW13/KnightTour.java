...
/*======================================
   ...
   n=5   .165s    over 7 executions
   n=6   .208s    over 4 executions
   n=7   .300s  over 4 executions
   n=8   4008s    over 1 executions
   ======================================*/
...
public void findTour( int x, int y, int moves )
{
        ...
        if ( solved ) {
                //System.out.println("Topher says: Has been solved!");
                System.exit(0);
        }
        ...
        //and recursively generate tour possibilities from current pos
                ...
                board[x][y] = 0;//set the position to 0
