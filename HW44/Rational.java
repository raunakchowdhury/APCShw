...
// Team QAFfee Converters: Raunak Chowdhury, Lily Yan
// APCS1 p2
...
public boolean equals( Object other )
{
        ...
        reduce();
        Rational ob = (Rational) other;
        ob.reduce();
        int thisNum = this._numerator;
        int thisDen = this._denominator;

        int otherNum = ob._numerator;
        int otherDen = ob._denominator;
        /* YOUR IMPLEMENTATION HERE */
        /*
         * Since you are reducing both rationals, and Java is ref-by-val, it stands to reason that
         * if the two Rationals are equal, then they will become aliases of each other. This eliminates
         * the need for additional code covering the alias case. We have provided an example of an alias
         * being compared to another class in the main() method.
         */
...
public int compareTo( Object other )
{
        ...
        if (!(other instanceof Rational)) {
                throw new ClassCastException("The Object you entered is not a Rational");
        }
        Rational ob = (Rational) other;
        int thisNumerator, otherNumerator;

        thisNumerator = _numerator * ob._denominator;
        otherNumerator = _denominator * ob._numerator;
...
public static void main( String[] args )
{
        ...
        Rational alias = v; // alias rational for testing equals
        System.out.println( "v.equals(v): " + v.equals(v) );
        System.out.println( "v.equals(w): " + v.equals(w) );
        System.out.println( "w.equals(x): " + w.equals(x) );
        System.out.println( "u.equals(w): " + u.equals(w) );
        System.out.println( "alias.equals(v): " + alias.equals(v) );
        /*~~~v~~~~~~~~~~down~goer~3~~~~~~~~~~~~~v~~~~~
           //fx~~~~~|~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|~~~~~*/
}
